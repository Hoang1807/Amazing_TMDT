...
<body id="page-top">
				...
				<div class="container-fluid">
					<div
						...
						<a href="#"
							...
							data-toggle="modal" data-target="#form" id="btnAddCate"> <i
							class="fas fa-plus fa-sm text-white-50"></i> Thêm Loại
						</a>
	...
	<!-- Page level plugins -->
	<script src="../js/seller/Chart.min.js"></script>

	<!-- Page level custom scripts -->
	<script src="../js/seller/chart-area-demo.js"></script>
	<script src="../js/seller/chart-pie-demo.js"></script>
