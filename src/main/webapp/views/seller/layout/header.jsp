	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			role="button" data-toggle="dropdown" aria-haspopup="true"> <span
				class="mr-2 d-none d-lg-inline text-gray-600 small">${sessionScope.store_account.storeName }</span>
				<img class="img-profile rounded-circle"
				src="https://cdn.doctailieu.com/images/2019/06/20/van-ta-con-bo-sua-chon-loc.jpg">
		</a> <!-- Dropdown - User Information -->
			<div
				class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
				aria-labelledby="userDropdown">
				<a class="dropdown-item" href="#"> <i
					class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i> Trang cá
					nhân
